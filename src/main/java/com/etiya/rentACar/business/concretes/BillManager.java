...
public class BillManager implements BillService {
    ...
    public BillManager(BillDao billDao, ModelMapperService modelMapperService, RentalService rentalService, OrderedAdditionalServiceService orderedAdditionalServiceService) {
    ...
    @Override
    public DataResult<List<ListBillDto>> findByRentDateBetween(LocalDate startDate, LocalDate endDate) {
